"""StreamingContextScrubber — stateful scrubber for memory-context spans in streaming text.

Ported from hermes-agent/agent/memory_manager.py. Strips
``<memory-context>...</memory-context>`` blocks that might leak across SSE
chunk boundaries.
"""
