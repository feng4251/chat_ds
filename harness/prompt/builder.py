...
PYTHON_RUNTIME_GUIDANCE = (
    ...
    "- Do not paste descriptive skill documentation, pseudo-code, or copied snippets from "
    "skill_view into `execute_code`. Use real executable code only, and prefer the skill's "
    "documented scripts for skill/API workflows.\n"
