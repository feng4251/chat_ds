...
SESSION_SKILL_USAGE_GUIDANCE = (
    ...
    "be selected when they are needed for the user's legitimate task, but the isolated script "
    "executor has no network access and cannot replace browser or remote-network capabilities; "
