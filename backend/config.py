...
class Settings(BaseSettings):
    ...
    # Native execution engines. Historical ``legacy`` conversation rows stay
    # readable, but the retired ChatDS Harness is never an executable engine.
    claude_code_engine_enabled: bool = True
    deepseek_harness_engine_enabled: bool = False
    default_agent_engine_id: Literal[
        "claude_code", "deepseek_harness"
    ] = "claude_code"
