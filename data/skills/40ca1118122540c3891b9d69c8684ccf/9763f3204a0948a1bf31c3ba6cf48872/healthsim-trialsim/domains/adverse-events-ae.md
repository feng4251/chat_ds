...
description: "Generate SDTM AE (Adverse Events) domain data with MedDRA coding hierarchy, \nseverity grading, causality assessment,\
  \ and outcome tracking. Foundation for \nsafety analysis. Triggers: \"adverse events\", \"AE domain\", \"safety data\",\
