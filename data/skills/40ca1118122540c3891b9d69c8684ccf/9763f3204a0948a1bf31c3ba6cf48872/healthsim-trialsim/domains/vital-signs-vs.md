---
name: vital-signs-vs
description: "Generate SDTM VS (Vital Signs) domain data with blood pressure, heart rate, \ntemperature, weight, and other\
  \ measurements at scheduled visits. Triggers: \n\"vital signs\", \"VS domain\", \"vitals\", \"blood pressure\", \"heart\
...
- name: VSORRESU
  ...
  origin: PROTOCOL
- name: VSSTRESC
  label: Character Result/Finding Std Format
  type: text
  length: 8
  required: false
  origin: DERIVED
- name: VSSTRESN
  label: Numeric Result/Finding Std Units
  type: integer
  length: 8
  required: false
  origin: DERIVED
