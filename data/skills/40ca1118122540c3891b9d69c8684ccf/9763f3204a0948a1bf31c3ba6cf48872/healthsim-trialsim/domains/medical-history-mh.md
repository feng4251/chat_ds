...
description: "Generate SDTM MH (Medical History) domain data for pre-existing conditions,\nsurgical history, and baseline\
  \ medical status. Essential for eligibility \nverification and baseline characterization. Triggers: \"medical history\"\
...
- name: MHSCAT
  ...
  origin: PROTOCOL
- name: MHENRF
  label: End Relative to Reference
  type: text
  length: 8
  required: false
  origin: PROTOCOL
- name: MHPTCD
  label: MedDRA PT Code
  type: integer
  length: 8
  required: false
  origin: PROTOCOL
- name: MHSOC
  label: Primary SOC Name
  type: text
  length: 8
  required: false
  origin: PROTOCOL
- name: MHSOCCD
  label: Primary SOC Code
  type: integer
  length: 8
  required: false
  origin: PROTOCOL
