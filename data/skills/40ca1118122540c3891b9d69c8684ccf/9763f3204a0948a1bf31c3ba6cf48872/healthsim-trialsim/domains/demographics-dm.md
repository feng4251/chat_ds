...
description: "Generate SDTM DM (Demographics) domain data with subject identifiers, \ndemographics, treatment arms, and reference\
  \ dates. Required for all clinical \ntrial submissions. Triggers: \"demographics\", \"DM domain\", \"subject data\", \n\"\
