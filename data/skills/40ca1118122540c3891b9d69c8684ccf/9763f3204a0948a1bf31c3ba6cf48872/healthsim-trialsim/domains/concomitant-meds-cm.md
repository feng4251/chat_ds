...
description: "Generate SDTM CM (Concomitant/Prior Medications) domain data with WHO-Drug \nDictionary coding, ATC classification,\
  \ and indication mapping. Triggers: \n\"concomitant medications\", \"CM domain\", \"prior meds\", \"background therapy\"\
...
- name: CMONGO
  ...
  origin: PROTOCOL
- name: CMATC1CD
  label: ATC Level 1 Code
  type: text
  length: 8
  required: false
  origin: DERIVED
- name: CMATC2CD
  label: ATC Level 2 Code
  type: text
  length: 8
  required: false
  origin: DERIVED
- name: CMATC3CD
  label: ATC Level 3 Code
  type: text
  length: 8
  required: false
  origin: DERIVED
- name: CMATC4CD
  label: ATC Level 4 Code
  type: text
  length: 8
  required: false
  origin: DERIVED
